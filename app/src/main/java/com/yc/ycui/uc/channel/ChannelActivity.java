package com.yc.ycui.uc.channel;
...
public class ChannelActivity extends AppCompatActivity implements View.OnClickListener, SelectAdapter.OnAction, UnSelectAdapter.OnAction {
    ...
    private void initData() {
         ...
         * check data exist
         */
        if (YcSPUtils.getInstance("data").getString("channel").isEmpty()) {
            List<ItemBean> initData = new ArrayList<>();
            initData.add(new ItemBean("军事大放送", true));
            initData.add(new ItemBean("娱乐娱乐娱乐娱乐", true));
            initData.add(new ItemBean("交通交通", true));
            initData.add(new ItemBean("国际国际国际", true));
            ...
            initData.add(new ItemBean("排球排球排球排球排球排球排球排球", true));
            ...
            initData.add(new ItemBean("生活生活生活生活", true));
            ...
            YcSPUtils.getInstance("data").put("channel", new Gson().toJson(initData));
        }
        Gson gson = new Gson();
        itemBeans = gson.fromJson(YcSPUtils.getInstance("data").getString("channel"), new TypeToken<List<ItemBean>>() {
        }.getType());
    }
...
//        YcSPUtils.getInstance("data").put("channel", new Gson().toJson(itemBeans));
