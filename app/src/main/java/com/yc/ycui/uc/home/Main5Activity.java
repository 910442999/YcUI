...
public class Main5Activity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, UcNewsHeaderPagerBehavior.OnPagerStateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uc_main_pager2);
        initView();
    }
    protected void initView() {
        ...
        findViewById(R.id.news_tv_header_pager).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Main5Activity.this, "点击我了", Toast.LENGTH_SHORT).show();
